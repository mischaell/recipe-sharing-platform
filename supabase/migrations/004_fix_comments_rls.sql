...
-- Users can create comments (user_id references profiles.id which equals auth.uid())
...
-- Users can create their own likes (user_id references profiles.id which equals auth.uid())
...
-- Users can create their own comment likes (user_id references profiles.id which equals auth.uid())
